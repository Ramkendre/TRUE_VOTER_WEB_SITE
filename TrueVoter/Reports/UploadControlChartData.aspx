<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UploadControlChartData.aspx.cs" Inherits="TrueVoter.Reports.UploadControlChartData" MasterPageFile="~/MasterPages/UserSite.Master" %>
...
<asp:Content ContentPlaceHolderID="MainContent" runat="server" ID="BodyContent">
    ...
    <div class="borderOuter-div-Form1">
        ...
        <div align="center" class="form-group">
            <table style="width: 870px; text-align: left">
                ...
                <tr>
                    <td style="text-align: left" class="auto-style1">Enter VoterList Staff No:</td>
                    <td style="text-align: left" class="auto-style2">
    ...
    <asp:UpdatePanel runat="server">
        <ContentTemplate>
            <div class="borderOuter-div-Form1" style="width: 1000Px; height: 100%; overflow: scroll">
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" PageSize="200" CssClass="table table-hover table-bordered" CellPadding="4" DataKeyNames="SrNo" ShowHeaderWhenEmpty="true"
