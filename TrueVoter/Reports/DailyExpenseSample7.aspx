<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/UserSite.Master" CodeBehind="DailyExpenseSample7.aspx.cs" Inherits="TrueVoter.Reports.DailyExpenseSample7" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="borderOuter-div-Form" id="divForPrint">
        <div class="borderHeading-div">
            ...
            <div align="Center" style="font-size: large; font-weight: bold">नमुना-7</div>
        </div>
        <%-- <div style="height: 9px"></div>--%>
        <br />
        <div align="Center" style="font-size: large; font-weight: bold">पक्षाने उमेदवारांसाठी केलेला विविध प्रकारच्या निवडणुकीचा खर्च</div>
        <br />
        <%--  <div style="height: 9px"></div>--%>
        <div class="form-group">
            <asp:GridView ID="gvPartyExpense" CssClass="table table-hover table-bordered" runat="server" OnDataBound="gvPartyExpense_DataBound" AutoGenerateColumns="false" ShowFooter="true">
                <Columns>
                    ...
                    <asp:BoundField HeaderText="स्था.स्व.सं.नाव" DataField="LocalBodyName" ItemStyle-Width="5%"></asp:BoundField>
        ...
        <table>
            <tr>
                <td style="padding-left: 10px">
                    <asp:Label ID="lbldateDetails" runat="server" Text="दिनांक .............रोजी ...........वा नमुना 7 सादर करित आहे."></asp:Label>
                </td>
            </tr>
            ...
            <tr>
                <td style="padding-left: 10px">
                    <asp:Label ID="lblDailyExpenseSample" runat="server" Text="सदर नमुना 7 हा दिनांक . . . . .   रोजी प्राप्त झाला. "></asp:Label>
                </td>
            </tr>
            <tr>
                <td style="height: 27px"></td>
            ...
            <tr>
                <td>टीप : 
                        <asp:Label ID="lblTip1" runat="server" Style="padding-left: 5px" Text="(१)एकूण सर्व सामान्य खर्चाची माहिती स्थानिक स्वराज्य संस्थांनिहाय नमुना 7 मध्ये, निकाल लागल्यापासून 90 दिवसाच्या आत, जिल्हाधिकारी/  महापालिका आयुक्त यांना सादर करावा. सदर नमुना त्यांच्यामार्फत छाननी होऊन राज्य निवडणूक आयोगाकडे अग्रेषित होईल याची खात्री करावी."></asp:Label>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="padding-left: 37px">
                    <asp:Label ID="lblTip3" runat="server" Text="(३)ओंनलाईन पद्धतीने पक्षाचा खर्च भरला असल्यास सदर नमुना 7 ऑटोमॅटिक तयार होईल. पक्षाच्या पदाधिकाऱ्याने फक्त नमुना डाऊनलोड करून, तपासून,  प्रिंट करून, सही करून, (१) प्रमाणे सादर करावा."></asp:Label>
                </td>
            </tr>
        </table>
    </div>
