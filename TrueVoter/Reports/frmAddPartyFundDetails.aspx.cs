...
{
    public partial class frmAddPartyFundDetails : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (btnSubmit.Text == "Submit")
                {
                    ...
                    SqlHelper.ExecuteNonQuery(con, CommandType.StoredProcedure, "uspInsertPartyFundDetailsWeb", par);
        ...
        public void BindGridView()
        {
            ...
            ds = SqlHelper.ExecuteDataset(con, CommandType.StoredProcedure, "uspGetPartyFundDetails", par);
        ...
        protected void lnkSubmit_Click(object sender, EventArgs e)
        {
            ...
            SqlHelper.ExecuteNonQuery(con, CommandType.StoredProcedure, "uspGetPartyFundDetailsStatusChange", par);
            BindGridView();
        }
        ...
        protected void lnkEdit_Click(object sender, EventArgs e)
        {
            ...
            ds.Clear();
            ds = SqlHelper.ExecuteDataset(con, CommandType.StoredProcedure, "uspGetPartyFundDetailsById", par);
