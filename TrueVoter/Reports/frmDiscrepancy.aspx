<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmDiscrepancy.aspx.cs" Inherits="TrueVoter.Reports.frmDiscrepancy" MasterPageFile="~/MasterPages/UserSite.Master" %>
                ...
                <table style="width: 700px;text-align:left;">
                    ...
                    <td>
                      ...
                      <%--<tr style="height: 10px">
                       ...
                       <%--<tr>
                        <td class="auto-style1">
                            <asp:Label runat="server" ID="Label1" Text="Enter Ward No"></asp:Label></td>
                        </td>
                    <td>
                        ...
                        <ContentTemplate>
                            <asp:GridView ID="gvCandidateList" runat="server" CssClass="table table-hover table-bordered" EmptyDataText="No Data Found..." ShowHeaderWhenEmpty="true"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Total Records" DataField="DailyExpensEntrys" />
                        ...
                        <ContentTemplate>
                            <asp:GridView ID="gvCandidateList" runat="server" CssClass="table table-hover table-bordered" EmptyDataText="No Data Found..." ShowHeaderWhenEmpty="true"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Ward No" DataField="WardNo" />
                                    <asp:BoundField HeaderText="LocalBody Name" DataField="LocalBodyName" />
                                    <asp:BoundField HeaderText="Total Fund" DataField="TotalFund" />
                                    <asp:BoundField HeaderText="Total Party Fund" DataField="TotalPartyFund" />
                                    <asp:BoundField HeaderText="Discrepancy" DataField="Discrepancy" />
                                    <asp:TemplateField HeaderText="View">
                                        <ItemTemplate>
                                            <asp:LinkButton runat="server" ID="lbtnGetDetails" CommandArgument='<%#Eval("usrMobileNumber")%>' OnClick="lbtnGetDetails_Click" Text="View"></asp:LinkButton>
                                        </ItemTemplate>
