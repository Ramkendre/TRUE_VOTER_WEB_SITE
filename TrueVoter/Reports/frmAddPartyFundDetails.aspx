<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmAddPartyFundDetails.aspx.cs" MasterPageFile="~/MasterPages/UserSite.Master" Inherits="TrueVoter.Reports.frmAddPartyFundDetails" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="borderOuter-div-Form">
        <div>
            <div class="borderHeading-div">
                <asp:Label ID="lblHeading" runat="server" Text="Party Fund Collection Details" Font-Bold="true" Font-Size="Medium"></asp:Label>
            </div>
        </div>
        <asp:UpdatePanel ID="UpdatePanel101" runat="server">
            <ContentTemplate>
                ...
                <table style="width: 700px;text-align:left;">
                    <asp:TextBox ID="txtFundID"  runat="server" CssClass="form-control" Visible="false"></asp:TextBox>
                    <tr>
                    ...
                    <tr style="height: 10px">
                     ...
                     <%--<asp:Panel runat="server" ID="pnlprovidername" Visible="true">
                    --%><tr>
                        <td class="auto-style1">
                            <asp:Label runat="server" ID="lblprovidername" Text="Provider Name" Visible="true"></asp:Label></td>
                        </td>
                    <td>
                        <asp:TextBox ID="txtProviderName" runat="server" CssClass="form-control" PlaceHolder="Provider Name" Visible="true"></asp:TextBox>
                    </td>
                        <td>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidatorParty" runat="server" ValidationGroup="sub" ControlToValidate="txtProviderName" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr style="height: 10px">
                        <td class="auto-style1"></td>
                    ...
                    <td>
                        ...
                        <td>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ValidationGroup="sub" ControlToValidate="txtAddress" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr style="height: 10px">
                        <td class="auto-style1"></td>
                    </tr>
                    <%--<asp:Panel runat="server" ID="pnlMoNo" Visible="true">--%>
                    <tr>
                        <td class="auto-style1">
                            <asp:Label runat="server" ID="lblMobNo" Text="Mobile No" onkeypress="return numbersonly(this,event)"  Visible="true"></asp:Label></td>
                        <td>
                            <asp:TextBox ID="txtmobNo" runat="server" CssClass="form-control" MaxLength="10" onkeypress="return numbersonly(this,event)" PlaceHolder="9999999999" Visible="true"></asp:TextBox>
                        </td>
                        <td>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidatorSeatNo" ValidationGroup="sub" runat="server" ControlToValidate="txtmobNo" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <%--</asp:Panel>--%>
                    <tr style="height: 10px">
                    ...
                    <td>
                        <asp:DropDownList ID="ddlSelectFundType" CssClass="form-control" runat="server"  AutoPostBack="true">
                           ...
                           <asp:ListItem Value="4">Other</asp:ListItem>   
                            <asp:ListItem Value="5">Cash In Hand</asp:ListItem>                
                        </asp:DropDownList>
                    </td>
                        <td>
                    ...
                    <td>
                        <asp:TextBox ID="txtAmount" runat="server" CssClass="form-control" onkeypress="return numbersonly(this,event)" PlaceHolder="Enter amount"></asp:TextBox>
                    </td>
                        <td>
                  ...
                  <%--  <tr>
                    ...
                    <asp:Panel runat="server" ID="pnlProviderBankName" Visible="true">
                    <tr>
                        <td class="auto-style1">
                            <asp:Label runat="server" ID="lblproviderbankNo" Text="Provider's Bank Name" Visible="true"></asp:Label></td>
                        </td>
                    <td>
                        <asp:TextBox ID="txtproviderbnkDtls" runat="server" CssClass="form-control" PlaceHolder="Provider's Bank Name" Visible="true"></asp:TextBox>
                    </td>
                        <td>
                            ...
                            <%--<asp:RegularExpressionValidator ID="rfvOnlyChar" runat="server"  ValidationGroup="sub" ErrorMessage="*" ForeColor="Red" ValidationExpression="^[A-Za-z]*$" ControlToValidate="txtproviderbnkDtls"></asp:RegularExpressionValidator>--%>
                        </td>
                    </tr>
                    <tr style="height: 10px">
                        <td class="auto-style1"></td>
                ...
                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="gvFundDetails" runat="server" CssClass="table table-hover table-bordered" EmptyDataText="No Data Found..." ShowHeaderWhenEmpty="true"
                            ...
                            PageSize="10" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" OnPageIndexChanging="gvFundDetails_PageIndexChanging">
                            <Columns>
                                ...
                                <%--<asp:BoundField HeaderText="From Whom" DataField="FromText" ItemStyle-Width="60px" />--%>
                                ...
                                <asp:TemplateField HeaderText="Edit">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkEdit" runat="server"
                                            CommandArgument='<%# Eval("FundID")%>'
                                            OnClientClick="return confirm('Are You sure to Update Selected Record?')"
