<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmAddFundDetails.aspx.cs" MasterPageFile="~/MasterPages/UserSite.Master" Inherits="TrueVoter.Reports.frmAddFundDetails" %>
            ...
            <ContentTemplate>
                ...
                <table style="width: 700px;text-align:left;">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtmobNo" runat="server" CssClass="form-control" MaxLength="10" onkeypress="return numbersonly(this,event)" PlaceHolder="Mobile No" Visible="true"></asp:TextBox>
                        </td>
                        <td>
