<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmHome.aspx.cs" Inherits="TrueVoter.Reports.frmHome" MasterPageFile="~/MasterPages/Site.Master" %>
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <div class="borderOuter-div-Form">
        ...
        <div style="text-align: center">
            ...
            <br />
            <br />
            <asp:LinkButton ID="btnCandiAppRegPro" runat="server" Text="Tutorial Presentation for Candidate App registration Process" ForeColor="Blue" OnClick="btnCandiAppRegPro_Click"></asp:LinkButton>
            <br />
            <br />
            <asp:LinkButton ID="lnkbtnDailyExpecandi" runat="server" Text="Tutorial Presentation for Filling Candidate Daily Expense" ForeColor="Blue" OnClick="lnkbtnDailyExpecandi_Click"></asp:LinkButton>
            <br />
            <br />
        </div>
    </div>
